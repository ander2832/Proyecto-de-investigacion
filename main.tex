...
\begin{document}
	...
	Depende de la velocidad con que el microprocesador recoge las instrucciones y las procesa, asi se libera mas rapido la memoria. Es muy importante para que el usuario tenga una mejor experiencia en la ejecucion de un programa.
